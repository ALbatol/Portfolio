...
<div className="px-[4%] pt-20 float-right md:hidden flex flex-col items-end" >
...
<nav className={`${openSideNav? 'space-y-4 translate-x-0 pb-8' : 'translate-x-full pl-9 overflow-clip'} ease-in-out duration-300`}> 
{SideNavArray.map((i)=> 
<>
{openSideNav? 
<>
